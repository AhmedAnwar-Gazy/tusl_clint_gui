...
public interface ChatClientListener {
     ...
     */
    void onNotificationsRetrieved(List<orgs.tuasl_clint.models2.Notification> notifications);
     ...
     */
    void onChatParticipantsRetrieved(List<orgs.tuasl_clint.models2.ChatParticipant> participants, int chatId);
}
